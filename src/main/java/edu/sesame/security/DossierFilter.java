...
@WebFilter(urlPatterns = { "/commandes", "/factures", "/nouveaucommande", "/nouveaufacture", "/editcommande",
		"/editfacture", "/updatecommande", "/updatefacture", "/deletecommande", "/deletefacture", "/commande",
		"/facture" })
