...
public interface DossierRepository extends JpaRepository<Dossier, Long> {
	...
	public Page<Dossier> findAll(@Param("n") String nom, Pageable pageable);

	@Query("select p from Dossier p where p.nom like :n and (p.dateFermeture=:df) order by p.dateCreation desc")
	public Page<Dossier> findAllByDateFermeture(@Param("n") String nom, @Param("df") Date dateFermeture,
			Pageable pageable);

	@Query("select p from Dossier p where p.nom like :n and p.dateCreation=:do order by p.dateCreation desc")
	public Page<Dossier> findAllByDateCreation(@Param("n") String nom, @Param("do") Date dateCreation,
			Pageable pageable);
	...
	public Page<Dossier> findAllByDateCreationFermeture(@Param("n") String nom, @Param("do") Date dateCreation,
			@Param("df") Date dateFermeture, Pageable pageable);
	...
	public Page<Dossier> findAllClosedByDateCreation(@Param("n") String nom, @Param("do") Date dateCreation,
			Pageable pageable);

	@Query("select p from Dossier p where p.nom like :n and p.dateFermeture!=null order by p.dateCreation desc")
	public Page<Dossier> findAllClosed(@Param("n") String nom, Pageable pageable);

	@Query("select p from Dossier p where p.nom like :n and p.dateFermeture=null order by p.dateCreation desc")
	public Page<Dossier> findAllNotClosed(@Param("n") String nom, Pageable pageable);
	...
	public Page<Dossier> findAllNotClosedByDateCreation(@Param("n") String nom, @Param("do") Date dateCreation,
			Pageable pageable);
