...
public interface CommandeRepository extends JpaRepository<Commande, Long> {
	...
	public Page<Commande> findAllCommandesClients(@Param("num") Long numeroDossier, @Param("x") Date date,
			Pageable pageable);

	@Query("select p from Commande p where p.fournisseur=null and p.valide=:v and p.dossier.numero=:num")
	public Page<Commande> findAllCommandesClients(@Param("num") Long numeroDossier, @Param("v") Boolean valide,
			Pageable pageable);
	...
	public Page<Commande> findAllCommandesFournisseurs(@Param("num") Long numeroDossier, @Param("x") Date date,
			Pageable pageable);

	@Query("select p from Commande p where p.client=null and p.valide=:v and p.dossier.numero=:num")
	public Page<Commande> findAllCommandesFournisseurs(@Param("num") Long numeroDossier, @Param("v") Boolean valide,
			Pageable pageable);
	...
	public Page<Commande> findAllCommandesOfFournisseur(@Param("num") Long numeroDossier, @Param("x") String code,
			Pageable pageable);
